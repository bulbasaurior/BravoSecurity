                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="services-iconbox flat-icon-left ">
                            <div class="icon">
                                <a href="serv1.php"><img src="images/services/v1/1.jpg" alt="image"></a>
                            </div><!-- /icon -->
                        
                            <div class="content">
                                <h6 class="title"><a href="serv1.php">Evaluación y Asesoría</a></h6>
                                <p>Nuestro servicio de evaluación y asesoría profesional en seguridad evita que las organizaciones cuenten con un esfuerzo de seguridad pobre y un gasto elevado por ese concepto.
                                </p>   
                                <div class="more-detail" >
                                   <a href="serv1.php">Ver Más <i class="fa fa-long-arrow-right"></i></a> 
                                </div>
                            </div><!-- /content -->
                        </div><!-- /flat-iconbox -->
                    </div><!-- /col-md-4 -->
