...
<head>
    ...
    <title>Seguridad para Eventos</title>
                    ...
                    <div class="row">
                        <div class="col-md-12">                    
                            <div class="page-title-heading">
                                <h2 class="title">Seguridad para Eventos</h2>
            ...
            <div class="container ">   
                <div class="row">
                    <div class="col-md-6 col-center">
                                <img src="images/services/single/6.jpg" class="img-responsive">
                    </div><!-- /col-md-6 -->
                </div>
                <br>
                <div class="row">
                    <div id="left" class="col-md-8 col-center">
